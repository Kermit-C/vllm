...
def run_lm_eval(model: str, tasks: str, quantization: str,
    ...
    model_args = f"pretrained={model},dtype=auto,gpu_memory_utilization=0.85,max_model_len={max_model_len},quantization={quantization},enforce_eager=True,max_num_seqs=16,trust_remote_code=True"
